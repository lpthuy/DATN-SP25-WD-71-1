...
<section class="signup page_customer_account">
    <div class="container">
        <div class="row">
            <div class="col-lg-2 col-12 col-left-ac">
                <div class="block-account">
                    <h5 class="title-account">Thông tin</h5>
                    <p>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="badge order-status-badge" id="order-status-{{ $order->id }}">
                                                ...
                                                {{-- 👈 Thêm dòng này để dịch trạng thái received --}}
                                                Đã nhận hàng
                                            ...
                                            <td id="order-action-{{ $order->id }}">
                                                ...
                                                <form id="received-form-{{ $order->id }}"
                                                    ...
                                                    onsubmit="return handleReceived(event, {{ $order->id }})">
                                                    @csrf
        ...
        fetch(form.action, {
            ...
            .then(data => {
                if (data.status === 'success') {
                    // ✅ Cập nhật giao diện
                    document.getElementById(`order-action-${orderId}`).innerHTML =
            ...
            function renderActionByStatus(statusText) {
                ...
                if (isFailedPayment) {
                    ...
                    actionCell.innerHTML = `
                        ...
                        `;
                } else if (status.includes("giao thành công") || status.includes("đã giao") || status
                    .includes("hoàn tất")) {
...
<div id="returnModal" class="cancel-modal" style="display: none;">
    <div class="cancel-modal-content">
        ...
        <form id="returnForm" enctype="multipart/form-data" method="POST"
            action="{{ route('order.return', ['id' => 0]) }}">
            @csrf
