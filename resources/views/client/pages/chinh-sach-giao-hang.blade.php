...
@section('content')
        ...
        <div class="container">
            <ul class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
                ...
                <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    <strong itemprop="name">Chính sách giao hàng</strong>
    ...
    <ul>
    <li>Đơn hàng nội và ngoại thành Hà Nội:</li></ul>
    ...
    <ul>
    <li>Đơn hàng ở các tỉnh thành khác:</li></ul>
    ...
    <p>Có thể thay đổi thời gian giao hàng nếu khách hàng yêu cầu và LOFI&nbsp;Style&nbsp;chủ động đổi trong trường hợp chịu ảnh hưởng của thiên tai hoặc các sự kiện đặc biệt khác.</p>
