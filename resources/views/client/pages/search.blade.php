    ...
    <div class="container">
        ...
        <div class="serachpc_searchpage section margin-bottom-20">
            ...
            <div class="search-results">
                ...
                @else
                <div class="swiper-container product-new-swiper">
                                        ...
                                        <div class="bottom-action">
                                            <div class="price-box">
                                                ...
                                                $price = $product->discount_price && $product->discount_price < $product->price
                                                    ...
                                                    : ($product->variants->first()->discount_price ?? $product->variants->first()->price ?? $product->price);
                                                    $originalPrice = $product->discount_price && $product->discount_price < $product->price
                                                        ? $product->price
                                                        : ($product->variants->first()->price ?? null);
                                                        @endphp
